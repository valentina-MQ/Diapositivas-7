...
print("EJERCICIO 3 - PREDICCION, LL(1) Y ASDR")
...
if is_ll1:
    ...
    print("  Los conjuntos de prediccion de cada no terminal son disjuntos.")
else:
...
class ASDR_Ej3:
    ...
    def S(self):
        #S -> A B C S'  (para una única produccion)
    ...
    def B(self):
        t = self.token()
        pred_c_tres = prediccion['B'][0][1]
        pred_eps    = prediccion['B'][1][1]
        if t in pred_c_tres and t not in pred_eps:
